...
export const metadata = { title: 'Add Resume — Admin' };
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="px-8 pt-7 pb-5 border-b border-[#e8e2d5] flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-[#1a1a1a]">Upload New Resume</h1>
          <p className="text-sm text-[#8b9aaa] mt-0.5">Add a new PDF resume to your collection</p>
        </div>
      </div>
      <div className="p-8">
        <ResumeForm />
