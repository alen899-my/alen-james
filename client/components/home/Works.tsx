...
export default function Works({ works, categories }: WorksProps) {
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-6 md:px-14 py-24">
            <motion.div
            ...
            <div className="mt-16 flex flex-col items-center gap-6">
                ...
                <Link 
                    href="/all-works"
                    className="group flex items-center gap-3 px-8 py-4 rounded-full bg-[var(--foreground)] text-[var(--background)] text-lg font-bold uppercase tracking-widest hover:scale-105 active:scale-95 transition-transform duration-200"
