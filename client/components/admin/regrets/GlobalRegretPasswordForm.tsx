...
import { updateGlobalRegretPasswordAction } from '@/lib/admin/actions/regrets.actions';
...
export default function GlobalRegretPasswordForm({ initialPassword }: Props) {
  ...
  const handleSave = async () => {
    ...
    const res = await updateGlobalRegretPasswordAction(password);
