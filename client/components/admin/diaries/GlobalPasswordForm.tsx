...
import { updateGlobalDiaryPasswordAction } from '@/lib/admin/actions/diaries.actions';
...
export default function GlobalPasswordForm({ initialPassword }: Props) {
  ...
  const handleSave = async () => {
    ...
    const res = await updateGlobalDiaryPasswordAction(password);
