...
import { updateGlobalTravelPasswordAction } from '@/lib/admin/actions/travels.actions';
...
export default function GlobalTravelPasswordForm({ initialPassword }: Props) {
  ...
  const handleSave = async () => {
    ...
    const res = await updateGlobalTravelPasswordAction(password);
